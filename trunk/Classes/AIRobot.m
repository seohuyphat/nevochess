...
- (id) initWith:(id)delegate
{
    if (self = [super init])
    {
        ...
        switch (aiType) {
            case NC_AI_XQWLight: _aiEngine = [[AI_XQWLight alloc] init]; break;
            case NC_AI_HaQiKiD:  _aiEngine = [[AI_HaQiKiD alloc] init]; break;
            case NC_AI_XQWLight_ObjC: _aiEngine = [[AI_XQWLightObjC alloc] init]; break;
...
- (int) _convertStringToAIType:(NSString *)name
{
    if ([name isEqualToString:@"XQWLight"]) {
        return NC_AI_XQWLight;
    } else if ([name isEqualToString:@"HaQiKiD"]) {
        return NC_AI_HaQiKiD;
    } else if ([name isEqualToString:@"XQWLightObjc"]) {
